              ...
              <div className="container mx-auto px-3 sm:px-4">
                  ...
                  <div className="mt-8 sm:mt-12 md:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 items-start">
                      {[
                          ...
                          >
                              {plan.highlight && <Chip label="Mais Popular" className="w-fit mb-3 sm:mb-4 -mt-1 sm:-mt-2 text-xs" />}
                    ...
                    >
                      <Card className={plan === 'Pro' ? 'border-primary' : ''}>
                        <CardHeader className="pb-3 sm:pb-4">
                            <Typography variant="h6" className={plan === 'Pro' ? 'text-lg sm:text-xl text-primary' : 'text-lg sm:text-xl'}>{plan}</Typography>
                        </CardHeader>
                    ...
                    <Card className="h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                      <CardHeader className="pb-3 sm:pb-4">
                        <div className="flex items-center justify-between mb-2">
                          <Chip label={post.category} variant="outlined" className="text-xs" />
