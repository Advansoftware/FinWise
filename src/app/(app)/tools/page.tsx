      ...
      <Stack spacing={6}>
        <Box>
          ...
          <Typography variant="body1" color="text.secondary">
            Calculadoras e ferramentas para planejamento financeiro.
          </Typography>
        </Box>
              ...
              <Stack alignItems="center" spacing={2}>
                ...
                >
                  <Box
                    ...
                    sx={{ height: 24, width: 24, color: "warning.main" }}
                  />
                </Box>
                <Typography variant="h6" color="warning.dark">
                  Dados do Holerite Necessários
                </Typography>
              </Stack>
            }
            subheader={
              <Typography variant="body2" color="warning.dark" sx={{ mt: 1 }}>
                Para utilizar as ferramentas de cálculo, você precisa configurar
                seus dados de holerite primeiro.
              </Typography>
            }
          />
          <CardContent sx={{ textAlign: "center" }}>
            <Typography variant="body1" color="warning.dark" paragraph>
              As calculadoras dependem das informações do seu salário bruto,
              descontos e ajuda de custo para fazer cálculos precisos de férias,
              13º salário e projeções.
            </Typography>
              ...
              <CardHeader
                ...
                subheader={
                  <Typography variant="body2" color="text.secondary">
                    Calcule o valor das suas férias considerando salário base e
                    adicionais.
                  </Typography>
                }
              />
  ...
  return (
    <Stack spacing={6}>
      <Box>
        ...
        <Typography variant="body1" color="text.secondary">
          Gaveta completa de calculadoras baseadas nos seus dados de holerite
      ...
      <Stack spacing={4}>
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Cálculos de férias, 13º salário e projeções salariais
          </Typography>
        </Box>
        <Grid container spacing={3}>
      ...
      <Stack spacing={4}>
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Rescisão trabalhista e empréstimo consignado
          </Typography>
        </Box>
        <Grid container spacing={3}>
          <Grid size={{ xs: 12, lg: 6 }}>
