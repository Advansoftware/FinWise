...
export const metadata: Metadata = {
  title: {
    default:
      "Gastometria - Dashboard Financeiro com IA e Ferramentas de Cálculo",
    template: "%s | Gastometria",
  },
  description:
    "Controle suas finanças pessoais com inteligência artificial. Dashboard completo com calculadora de férias, 13º salário, projeção salarial, gestão de gastos, orçamentos e análises automáticas.",
  keywords: [
    "finanças pessoais",
    "controle financeiro",
  ...
  openGraph: {
    ...
    description:
      "Controle suas finanças pessoais com IA. Dashboard completo com calculadora de férias, 13º salário, projeção salarial, gestão de gastos e análises automáticas.",
    images: [
      {
        url: "/logo.svg",
        width: 1200,
  ...
  twitter: {
    ...
    title:
      "Gastometria - Dashboard Financeiro com IA e Calculadoras Trabalhistas",
    description:
      "Controle suas finanças com IA. Calculadora de férias, 13º salário, projeção salarial, dashboard completo para gestão de gastos e análises.",
    images: ["/logo.svg"],
    creator: "@gastometria",
  },
