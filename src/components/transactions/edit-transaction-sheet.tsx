    ...
    >
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <Box sx={{ p: 3, borderBottom: 1, borderColor: 'divider', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box>
                <Typography variant="h6" fontWeight="bold">Editar Transação</Typography>
        ...
        <Box sx={{ flex: 1, overflowY: 'auto', p: 3 }}>
            <Stack spacing={4}>
                {/* Type Selection */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography variant="body2" fontWeight="medium" align="right">Tipo</Typography>
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
                         <Button
                            variant={formState.type === 'expense' ? 'contained' : 'outlined'}
                            color="error"
                         ...
                         <Button
                             variant={formState.type === 'income' ? 'contained' : 'outlined'}
                             color="success"
                ...
                {/* Item */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography component="label" htmlFor="item" variant="body2" fontWeight="medium" align="right">Item</Typography>
                    <TextField 
                        id="item" 
                        fullWidth 
                        size="small"
                ...
                {/* Establishment */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography component="label" htmlFor="establishment" variant="body2" fontWeight="medium" align="right">Local</Typography>
                    <TextField 
                        id="establishment" 
                        fullWidth 
                        size="small"
                ...
                {/* Quantity */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography component="label" htmlFor="quantity" variant="body2" fontWeight="medium" align="right">Qtd.</Typography>
                    <TextField 
                        id="quantity" 
                        type="number" 
                        fullWidth 
                ...
                {/* Amount */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography component="label" htmlFor="amount" variant="body2" fontWeight="medium" align="right">Valor</Typography>
                    <TextField 
                        id="amount" 
                        type="number" 
                        fullWidth 
                ...
                {/* Date */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography component="label" htmlFor="date" variant="body2" fontWeight="medium" align="right">Data</Typography>
                    <Box>
                        <SingleDatePicker 
                            date={new Date(formState.date || new Date())} 
                            setDate={(d) => handleInputChange('date', d?.toISOString() || new Date().toISOString())} 
                        />
                    </Box>
                </Box>
                ...
                {/* Wallet */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography component="label" htmlFor="wallet" variant="body2" fontWeight="medium" align="right">Carteira</Typography>
                    <FormControl fullWidth size="small">
                        <Select 
                            ...
                            displayEmpty
                        >
                            <MenuItem value="" disabled>Selecione uma carteira</MenuItem>
                            {wallets.map(wallet => (
                ...
                {/* Category */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography component="label" htmlFor="category" variant="body2" fontWeight="medium" align="right">Categoria</Typography>
                    <FormControl fullWidth size="small">
                        <Select 
                ...
                {/* Subcategory */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography component="label" htmlFor="subcategory" variant="body2" fontWeight="medium" align="right">Subcategoria</Typography>
                    <FormControl fullWidth size="small">
                        <Select 
                            value={formState.subcategory || 'none'} 
                            onChange={(e) => handleInputChange('subcategory', e.target.value)}
                            disabled={!formState.category || availableSubcategories.length === 0}
                        >
                ...
                {/* Update All */}
                <Box sx={{ display: 'grid', gridTemplateColumns: '100px 1fr', alignItems: 'center', gap: 2 }}>
                    <Typography component="label" htmlFor="update-all" variant="body2" fontWeight="medium" align="right">Aplicar a todos</Typography>
