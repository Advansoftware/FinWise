...
export function SeveranceCalculator({ payrollData }: SeveranceCalculatorProps) {
  ...
  const [rescissionType, setRescissionType] = useState<RescissionType>(
    "demissao-sem-justa-causa"
  );
  const [vacationDays, setVacationDays] = useState<number>(0);
  const [fgtsBalance, setFgtsBalance] = useState<number>(0);
  const [calculation, setCalculation] = useState<SeveranceCalculation | null>(
    null
  );
  ...
  const calculateSeverance = () => {
    ...
    switch (rescissionType) {
      ...
      case "demissao-com-justa-causa":
        ...
        feriasPendentes =
          vacationDays > 30 ? dailySalary * (vacationDays - 30) * 1.333 : 0;
        break;
      ...
      case "comum-acordo":
        ...
        const noticeAgreement = Math.min(
          30 + Math.floor(workMonths / 12) * 3,
          90
        );
    ...
    const totalReceive =
      salarioAviso + feriasPendentes + decimoTerceiro + fgtsFine;
            ...
            <Grid container spacing={1.5}>
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <Stack direction="row" justifyContent="space-between">
                  ...
                  <Typography variant="caption" fontWeight="medium">
                    {formatCurrency(payrollData.grossSalary / 30)}
                  </Typography>
                </Stack>
              </Grid>
            </Grid>
          ...
          <Grid container spacing={2}>
            <Grid size={{ xs: 12, sm: 6 }}>
              <TextField
                ...
                onChange={(e) =>
                  setRescissionType(e.target.value as RescissionType)
                }
                fullWidth
                size="small"
              >
                <MenuItem value="demissao-sem-justa-causa">
                  Demissão sem Justa Causa
                </MenuItem>
                <MenuItem value="demissao-com-justa-causa">
                  Demissão com Justa Causa
                </MenuItem>
                <MenuItem value="pedido-demissao">Pedido de Demissão</MenuItem>
                <MenuItem value="comum-acordo">
                  Comum Acordo (Art. 484-A)
                </MenuItem>
              </TextField>
            </Grid>
            ...
            <>
              ...
              <Stack spacing={2}>
                  ...
                  {calculation.fgtsFine > 0 && (
                    <Grid size={{ xs: 12, sm: 6 }}>
                      ...
                      >
                        ...
                        <Typography variant="caption" color="text.secondary">
                          {rescissionType === "comum-acordo" ? "20%" : "40%"} do
                          saldo
                        </Typography>
                      </Paper>
                    </Grid>
                ...
                >
                  ...
                  >
                    <Info size={16} /> Informações sobre{" "}
                    {getRescissionTitle(rescissionType)}:
                  </Typography>
                  <Stack
                    component="ul"
                    spacing={0.5}
                  ...
                  >
                    {rescissionType === "demissao-sem-justa-causa" && (
                      <>
                        ...
                        <li>
                          • Desconto de INSS e IR sobre verbas rescisórias
                        </li>
                      </>
                    )}
                    {rescissionType === "demissao-com-justa-causa" && (
                      <>
                        ...
                        <li>
                          • Justa causa deve ser comprovada pelo empregador
                        </li>
                      </>
                    )}
                    {rescissionType === "pedido-demissao" && (
                      <>
                        ...
                        <li>
                          • FGTS pode ser sacado apenas em casos específicos
                        </li>
                        <li>
                          • Aviso prévio pode ser dispensado pelo empregador
                        </li>
                      </>
                    )}
