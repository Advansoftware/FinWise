...
export function INSSCalculator({ payrollData }: INSSCalculatorProps) {
  ...
  const calculateINSS = () => {
    ...
    const registeredINSS =
      mode === "payroll" ? getINSSFromPayroll(payrollData) : 0;
    ...
    const effectiveRate =
      grossSalary > 0 ? (monthlyContribution / grossSalary) * 100 : 0;
    ...
    const replacementRate = Math.min(
      0.6 + (totalContributionYears - minContributionTimeMen) * 0.02,
      1
    );
  ...
  useEffect(() => {
    if (
      ...
      (mode === "manual" && manualData.grossSalary > 0)
    ) {
      calculateINSS();
    }
  }, [
          ...
          {calculation && (
            <>
              ...
              {(() => {
                ...
                const calculatedINSS = calculateINSSFromSalary(
                  payrollData.grossSalary
                );
                  ...
                  <Stack spacing={2}>
                    {registeredINSS > 0 && (
                      <Paper
                        variant="outlined"
                        sx={{
                          bgcolor: isConsistent
                            ? alpha(theme.palette.success.main, 0.1)
                            : alpha(theme.palette.warning.main, 0.1),
                          borderColor: isConsistent
                      ...
                      >
                        ...
                        >
                          ...
                          <Typography
                            variant="subtitle2"
                            color={
                              isConsistent ? "success.main" : "warning.main"
                            }
                          >
                            Validação do INSS
                          </Typography>
                        ...
                        <Stack spacing={0.5}>
                          ...
                          {isConsistent ? (
                            ...
                            >
                              ⚠️ Diferença de{" "}
                              {formatCurrency(
                                Math.abs(registeredINSS - calculatedINSS)
                              )}{" "}
              ...
              >
                ...
                <Grid container spacing={2}>
                  <Grid size={{ xs: 12, sm: 6 }}>
                    ...
                    >
                      ...
                      <Typography variant="caption" color="text.secondary">
                        {formatPercentage(calculation.contributionRate)} do
                        salário
                      </Typography>
                    </Paper>
                  </Grid>
                      ...
                      <TableBody>
                        {inssTable.map((bracket, index) => (
                          <TableRow key={index}>
                            ...
                            <TableCell>
                              {payrollData.grossSalary >= bracket.min &&
                ...
                >
                  ...
                  >
                    <li>
                      • Contribuição obrigatória descontada do salário bruto
                    </li>
                    <li>
                    ...
                    <li>
                      • Cálculos são estimativas baseadas nas regras atuais
                    </li>
                  </Stack>
                </Paper>
              </Stack>
