...
export function FGTSCalculator({ payrollData }: FGTSCalculatorProps) {
  ...
  const calculateFGTS = () => {
    ...
    for (let i = 0; i < futureMonths; i++) {
      projectedBalance =
        projectedBalance * (1 + annualInterestRate / 12) + monthlyDeposit;
    }
            ...
            <>
              ...
              <Stack spacing={2}>
                ...
                >
                  ...
                  >
                    <li>
                      • O FGTS é depositado mensalmente pelo empregador (8% do
                      salário bruto)
                    </li>
                    <li>
                      • Rendimento atual: 3% ao ano + TR (Taxa Referencial)
                    </li>
                    <li>
                      • Pode ser sacado em situações específicas (demissão,
                      compra da casa própria, etc.)
                    </li>
                    <li>
