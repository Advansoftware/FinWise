...
export function SalaryProjectionCalculator({
  payrollData,
}: SalaryProjectionCalculatorProps) {
          ...
          <Grid container spacing={2}>
            <Grid size={{ xs: 12, sm: 6 }}>
              <TextField
                ...
                onChange={(e) =>
                  setIncreasePercentage(parseFloat(e.target.value))
                }
                fullWidth
                size="small"
              >
            ...
            >
              ...
              <Stack spacing={1}>
                ...
                >
                  ...
                  <Chip
                    label={`+${formatCurrency(result.monthlyIncrease)}`}
                    size="small"
                    color="success"
                    variant="outlined"
                  />
                ...
                >
                  ...
                  <Chip
                    label={`+${formatCurrency(result.yearlyIncrease)}`}
                    size="small"
                    color="success"
                    variant="outlined"
                  />
                ...
                >
                  ...
                  <Chip
                    label={formatCurrency(result.totalEarnings)}
                    color="primary"
                    sx={{ fontWeight: "bold" }}
                  />
                </Stack>
