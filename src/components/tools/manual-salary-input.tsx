    ...
    >
      ...
      {data.grossSalary > 0 && data.netSalary > 0 && (
        ...
        >
          ...
          Bruto: {formatCurrency(data.grossSalary)} | Líquido:{" "}
          {formatCurrency(data.netSalary)} | Desconto:{" "}
          {formatCurrency(data.grossSalary - data.netSalary)} (
          {(
            ((data.grossSalary - data.netSalary) / data.grossSalary) *
            100
          ).toFixed(1)}
          %)
        </Box>
