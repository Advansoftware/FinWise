...
export function BudgetGuidance({ onBudgetCreated }: BudgetGuidanceProps) {
    ...
    if (fixedPercentage > 50) {
      ...
      return categories.map((cat) => {
        ...
        return {
          ...cat,
          percentage:
            (cat.percentage / totalOtherPercentage) * remainingPercentage,
        };
      });
    }
  ...
  const totalPercentage = adjustedCategories.reduce(
    ...
    switch (status) {
      case "critical":
        return {
          ...
          description:
            "Suas despesas superam sua renda. Ação urgente necessária!",
          color: "destructive",
          suggestions: [
      ...
      case "tight":
        return {
          ...
          description:
            "Mais de 70% da renda comprometida. Cuidado com imprevistos.",
          color: "destructive",
          suggestions: [
      ...
      case "moderate":
        return {
          ...
          description:
            "Orçamento equilibrado, mas com pouca margem para imprevistos.",
          color: "default",
          suggestions: [
  ...
  return (
    <Stack spacing={3}>
                ...
                <Grid container spacing={2} sx={{ textAlign: "center" }}>
                  ...
                  <Grid size={{ xs: 6, md: 3 }}>
                    <Typography
                      ...
                      fontWeight="bold"
                      color={
                        remainingAfterFixed >= 0 ? "success.main" : "error.main"
                      }
                    >
      ...
      {numericIncome > 0 && (
        <Alert
          severity={statusInfo.color === "destructive" ? "error" : "info"}
          icon={<AlertTriangle />}
        >
            ...
            <Stack spacing={2}>
                      ...
                      <Box
                        sx={{
                          ...
                          bgcolor: category.color
                            .replace("bg-", "")
                            .replace("-500", ".main")
                            .replace("-600", ".dark"), // This is a hack, ideally use theme colors or map properly
                          color: "white",
                          display: "flex",
                          alignItems: "center",
              ...
              {Math.abs(totalPercentage - 100) > 0.1 && (
                <Alert severity="warning" icon={<InfoIcon />}>
                  ...
                  Os percentuais devem somar 100%. Atualmente:{" "}
                  {totalPercentage.toFixed(1)}%
                </Alert>
              )}
      ...
      {showFutureScenario && numericFutureIncome > 0 && (
        <Card>
          <CardHeader
            ...
            subheader={`Como ficará seu orçamento quando a renda mudar para ${formatCurrency(
              numericFutureIncome
            )}`}
          />
          <CardContent>
            <Stack spacing={3}>
              ...
              <Stack spacing={2}>
                <Typography variant="subtitle1" fontWeight="bold">
                  Recomendações para o cenário futuro:
                </Typography>
                <Stack spacing={2}>
                  {futureAvailableIncome > availableIncome ? (
                    <>
                      ...
                      >
                        <Typography variant="body2" color="success.dark">
                          ...
                          Priorize: Reserva de emergência (20%), investimentos
                          (15%), e melhore qualidade de vida moderadamente.
                        </Typography>
                      </Paper>
                      <Paper
                        variant="outlined"
                      ...
                      >
                        <Typography variant="body2" color="info.dark">
                          <Box component="strong" display="block">
                            💡 Sugestão de distribuição futura:
                          </Box>
                          Moradia:{" "}
                          {(
                            (numericFixed / futureAvailableIncome) *
                            100
                          ).toFixed(1)}
                    ...
                    >
                      <Typography variant="body2" color="warning.dark">
                        <Box component="strong" display="block">
                          ⚠️ Redução de renda prevista
                        </Box>
                        Prepare-se: Aumente reservas agora, renegocie dívidas,
        ...
        <CardContent>
          <Stack spacing={2}>
            ...
            >
              ...
              <Typography variant="body2" color="warning.dark">
                Considere dividir o aluguel, negociar com proprietário ou buscar
                um local mais barato. Acima de 40% compromete muito o orçamento
                familiar.
              </Typography>
            </Paper>
            ...
            >
              ...
              <Typography variant="body2" color="error.dark">
                Priorize renegociar para alongar parcelas. Mesmo aumentando o
                prazo total, é melhor que quebrar o orçamento mensal e acumular
                mais dívidas.
              </Typography>
            </Paper>
            ...
            >
              ...
              <Typography variant="body2" color="info.dark">
                Use suas transações passadas para identificar padrões reais de
                gasto. Muitas vezes gastamos mais em determinadas categorias do
                que imaginamos.
              </Typography>
            </Paper>
            ...
            >
              ...
              <Typography variant="body2" color="success.dark">
                50% necessidades, 30% desejos, 20% poupança. Mas adapte à sua
                realidade: se está endividado, priorize quitação antes de focar
                em poupança.
              </Typography>
            </Paper>
          </Stack>
