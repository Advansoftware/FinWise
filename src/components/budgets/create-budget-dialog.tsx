...
export function CreateBudgetDialog({
  ...
  const expenseCategories = categories.filter(
    (c) => c !== "Salário" && c !== "Vendas" && c !== "Investimentos"
  );
  ...
  const handleSuggestion = () => {
    ...
    startSuggesting(async () => {
      ...
      const transactionsFromLastMonth = allTransactions.filter(
        (t) =>
                ...
                render={({ field, fieldState: { error } }) => (
                  <FormControl fullWidth error={!!error}>
                    <Stack direction="row" spacing={1} alignItems="flex-start">
                      ...
                      <ProUpgradeButton
                        requiredPlan="Plus"
                        tooltipContent="Desbloqueie sugestões de orçamento com IA com o plano Plus."
                      >
                        <Tooltip title="Sugestão de IA">
                          <span>
                            <Button
                              ...
                              disabled={
                                isSuggesting || !selectedCategory || !isPlus
                              }
                            >
                              {isSuggesting ? (
