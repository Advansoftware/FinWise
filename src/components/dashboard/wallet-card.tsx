...
export function WalletCard({ transactions }: WalletCardProps) {
  ...
  return (
    ...
    >
      ...
      />
      <CardContent
        sx={{ pb: 1.5, flex: 1, display: "flex", flexDirection: "column" }}
      >
        <Stack spacing={2} sx={{ height: "100%" }}>
          ...
          >
            ...
            <Typography
              variant="body2"
              fontWeight="bold"
              color={(netFlow || 0) >= 0 ? "success.main" : "error.main"}
            >
            ...
            >
              ...
              <Stack direction="row" alignItems="center" spacing={1}>
                <LinearProgress
                  variant="determinate"
                  value={
                    totalExpense > 0 ? (topCategory[1] / totalExpense) * 100 : 0
                  }
