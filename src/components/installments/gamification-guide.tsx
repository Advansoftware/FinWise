...
export function GamificationGuide({
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "levels" | "badges" | "achievements"
  >("overview");
              ...
              {activeTab === "overview" && (
                ...
                >
                  <Stack spacing={3}>
                          ...
                          {currentLevel && (
                            <Box>
                              ...
                              >
                                ...
                                <Typography variant="caption">
                                  {currentLevel.pointsToNext} pontos restantes
                                </Typography>
                              </Box>
                              <LinearProgress
                                variant="determinate"
                    ...
                    <Card>
                      <CardHeader
                        title="Como Ganhar (ou Perder) Pontos"
                        titleTypographyProps={{ variant: "h6" }}
                      />
                      <CardContent>
                        <Stack spacing={1.5}>
                    ...
                    >
                      <CardContent sx={{ textAlign: "center", py: 4 }}>
                        ...
                        >
                          A gamificação transforma uma tarefa chata (pagar
                          contas) em algo divertido e recompensador. Cada
                          pagamento em dia é uma vitória que você pode
                          comemorar!
                        </Typography>
                      </CardContent>
                    </Card>
                            ...
                            <Box sx={{ display: "flex", gap: 2 }}>
                              <Box
                                sx={{
                                  ...
                                  bgcolor: level.color
                                    .replace("bg-", "")
                                    .replace("-500", ".main"), // This is a rough mapping, might need adjustment or explicit colors
                                  display: "flex",
                                  alignItems: "center",
                                  justifyContent: "center",
